...
#define EDITOR_CONSOLE 0

	#define _RAKNET_SUPPORT_ConnectionGraph2 EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_RakNetCommandParser EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_LogCommandParser EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_ConsoleServer EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_RakNetTransport EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_TelnetTransport EDITOR_CONSOLE
	#define _RAKNET_SUPPORT_TCPInterface EDITOR_CONSOLE
