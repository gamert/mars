...
//zzAdd20150515: for test log...
#define RAKNET_LOG_ZZ 1
//#define RAKNET_DEBUG_PAK_SEQ
...
extern int g_log;
	...
	#define CC_PRINTF
		...
		#define  LOG_TAG    "Nt"
		#define RAKNET_LOG(...) if(g_log)__android_log_print(ANDROID_LOG_DEBUG,LOG_TAG,__VA_ARGS__)
	...
	#else
		#define RAKNET_LOG(...) if(g_log)CCLOG(0, __VA_ARGS__)
...
#ifndef SLIGHT_CONGESTION
#define SLIGHT_CONGESTION 0
#endif
...
#if ENCHENCE == 1
#define _MODULE_MTU_TEST 1
#define _MODULE_FIX_CONNECTION_ATTEMPT 1
#define _MODULE_COMMON_FIX 1
#define _MODULE_FIX_GUID_GEN 1
#define _MODULE_FIX_ACK_NAK_DOS 1
#define _MODULE_KEEP_CONN_AND_RESET 1
#else
#define _MODULE_MTU_TEST 0
#define _MODULE_FIX_CONNECTION_ATTEMPT 0
#define _MODULE_COMMON_FIX 0
#define _MODULE_FIX_GUID_GEN 0
#define _MODULE_FIX_ACK_NAK_DOS 0
#define _MODULE_KEEP_CONN_AND_RESET 0
#endif
